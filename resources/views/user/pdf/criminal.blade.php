...
<table align="center" border="0" width="100%">
    <ol>
        ...
        <tr>
            @if($criminal->job)
                <td colspan="4">4. อาชีพ : <label><?php echo $criminal->job ?></label></td>
            @else
                <td colspan="4">4. อาชีพ : <label> - </label></td>
            @endif

                @if($criminal->workplace_name)
                    <td colspan="2">สถานที่ทำงาน : <label><?php echo $criminal->workplace_name ?></label></td>
                @else
        ...
        <tr>
            @if($criminal->vehicle)
                <td colspan="1">15. ยานพาหานะที่ใช้: <label><?php echo $criminal->vehicle ?></label></td>
            @else
                <td colspan="1">15. ยานพาหานะที่ใช้: <label> - </label></td>
            @endif
    ...
    <tr>
        <td colspan="3" >ผู้จัดทำ: <label><?php echo $criminal->police_name ?></label></td>
    ...
    <tr>
        <td colspan="8">ตำแหน่ง: <label><?php echo $criminal->rank ?></label></td>
