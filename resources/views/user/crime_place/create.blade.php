...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <a href="/home">หน้าหลัก</a>/แบบประวัติสถานที่ที่เกี่ยวข้องกับอาชญากรรม
        ...
        <section class="content">
            <div style="padding-top: 2em">
                <div class="panel panel-warning">
                    <div class="panel-heading">แบบประวัติสถานที่ที่เกี่ยวข้องกับอาชญากรรม</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal" id="save" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text"
                                                       ...
                                                       value=""
                                                       class="form-control"
                                                       placeholder="ชื่อผู้ดำเนินกิจการ/ผู้ดูแล">
                                            </div>
                                            <div class="col-md-2">
                                                <a href="#" id="search_manager_name"
                                                   class="btn btn-default">ค้นหา</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label style="text-align: left"
                                                   class="col-md-1 control-label">ปี</label>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"
                                                       ...
                                                       value=""
                                                       class="form-control"
                                                       placeholder="ที่อยู่ตามบัตรประจำตัวประชาชน">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">
                                                8.พฤติการณ์ ประวัติที่เคยเกี่ยวข้องกับการประพฤติผิด</label>
                                            <div class="col-md-7">
                                        <textarea rows="4" cols="50"
                                                  name="place[place_crime_desc]"
                                                  class="form-control" placeholder="ข้อมูลสำคัญที่ควรทราบ">
                                        </textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="container" id="map-canvas"
                                                 style="text-align: center; height:500px; width: 800px;"></div>
    ...
    <script type="text/javascript">
        ...
        function save(id) {
            if(confirm("คุณต้องการที่จะบันทึกสถานที่นี้")){
                ...
                form.setAttribute('action',"/crime_place/create")
                form.submit()
            }
        }
    </script>
